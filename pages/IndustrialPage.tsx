        ...
        <div className="max-w-[1100px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col items-center">
              {/* Imagen: termotanque */}
              <img src="https://images.unsplash.com/photo-1614777594924-4f40f25e7914?auto=format&fit=crop&w=600&q=80" className="w-full h-72 object-cover rounded-[40px] mb-8 shadow-xl" alt="Termotanque Solar" />
            ...
            <div className="flex flex-col items-center">
              ...
              <img src="https://images.unsplash.com/photo-1544923246-77307dd654ca?auto=format&fit=crop&w=600&q=80" className="w-full h-72 object-cover rounded-[40px] mb-8 shadow-xl" alt="Bombeo Solar" />
