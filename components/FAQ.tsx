...
const FAQ: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Siempre deben estar orientados hacia el norte."
    }
  ];
    ...
    <section id="faq" className="w-full py-24 px-6 bg-white">
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="mt-16 text-center p-8 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
          ...
          <a href="https://wa.me/541162084045" target="_blank" rel="noopener noreferrer" className="text-primary font-bold hover:underline">Hablá con nuestro equipo técnico</a>
        </div>
      </div>
    </section>
  );
