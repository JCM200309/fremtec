...
const WhatsAppButton: React.FC = () => {
  const phoneNumber = "541162084045"; 
  const message = encodeURIComponent("Hola, obtuve tu numero de la pagina web de Fremtec. Te queria solicitar más información sobre paneles solares");
